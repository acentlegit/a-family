...
async function orchestrateIntent(req) {
    ...
    const povOptions = await (0, ollama_service_1.generatePovOptions)(naturalLanguageIntent, industry);
    const sessionTypes = await (0, ollama_service_1.generateSessionTypes)(naturalLanguageIntent, industry);
