...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const checkResponse = await fetch(`${getApiUrl()}/auth/check-default-user`, {
        method: 'POST',
      ...
      if (checkData.isDefaultUser) {
        setError('This email is reserved. Please use the provided login credentials instead.');
        setLoading(false);
        return;
      }
